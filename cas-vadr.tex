...
\textbf{VADR proceeds over 4 stages to validate and annotate sequences}
...
\begin{slide}
\begin{center}
\normalsize{\textbf{VADR has been used to validate and annotate \\ Norovirus and Dengue virus sequences for GenBank since 2018}}

\scriptsize
\begin{tabular}{r|r|r}
                                                  &Norovirus      &Dengue virus   \\ \hline
length                                            &7575.6         &10703.5        \\
\# seqs                                           &44936          &113211         \\
\% seqs full length                               &5.1\%          &8.4\%          \\
\% Ns                                             &0.5\%          &0.2\%          \\
\% seqs with stretch of $>=50$ Ns                 &1.0\%          &0.4\%          \\
average \% identity                               &81.6\%         &94.4\%         \\
seconds per sequence (VADR v1.0)                  &42.4           &92.6           \\
required RAM (VADR v1.0)                          &8Gb            &8Gb            \\
total running time, CPU days (VADR v1.0)          &1.1            &10.2           \\
\end{tabular}
\end{center}
...
length                                            &7575.6         &10703.5        &\textcolor{red}{29903.0}        \\
\# seqs                                           &44936          &113211         &\textcolor{red}{1616891}        \\
...
average \% identity                               &81.6\%         &94.4\%         &\textcolor{red}{99.4\%}         \\
seconds per sequence (VADR v1.0)                  &42.4           &92.6           &\textcolor{red}{331.8}          \\
required RAM (VADR v1.0)                          &8Gb            &8Gb            &\textcolor{red}{64Gb}           \\
total running time, CPU days (VADR v1.0)          &1.1            &10.2           &\textcolor{red}{6187.6}         \\
\end{tabular}
\end{center}
...
\hline
& & & & & & & & \\
1.0         &$-$         &$-$         &$-$         &1           &64 Gb       &329.91      &9164.3      &-           \\
%1.1         &$+$         &$+$         &$-$         &1           &64 Gb       &49.35       &1370.7      &6.7         \\
& & & & & & & & \\
1.4.1       &$+$         &$+$         &$+$         &1           &2 Gb        &2.51        &69.8        &131.4       \\
& & & & & & & & \\
1.4.1       &$+$         &$+$         &$+$         &2           &4 Gb        &1.49        &41.5        &220.8       \\
& & & & & & & & \\
1.4.1       &$+$         &$+$         &$+$         &4           &8 Gb        &0.65        &18.0        &509.9       \\
& & & & & & & & \\
\textbf{1.4.1}&\textbf{$+$}&\textbf{$+$}&\textbf{$+$}&\textbf{8}  &\textbf{16 Gb}&\textbf{0.33}&\textbf{9.3}&\textbf{986.8}\\
& & & & & & & & \\
1.4.1       &$+$         &$+$         &$+$         &16          &32 Gb       &0.23        &6.5         &1417.9      \\
& & & & & & & & \\
1.4.1       &$+$         &$+$         &$+$         &32          &64 Gb       &0.13        &3.7         &2462.2      \\
\end{tabular}
\end{center}
